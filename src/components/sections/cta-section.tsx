...
export function CtaSection() {
  return (
    <section className="bg-gradient-to-r from-pink-600 to-pink-800 py-16 sm:py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-pink-100 sm:mb-10 sm:text-xl">
          ...
          <Link target="_blank" href={globalVariable.whatsappLink}>
            <Button
              size="lg"
              className="bg-white text-lg font-semibold text-pink-600 hover:bg-pink-50"
            >
              Agendar Cita
