  ...
  return (
    <AnimatedSection className="bg-white py-16 sm:py-20">
      <div id="testimonios" className="container mx-auto px-4">
        <h2 className="mb-8 text-center text-3xl font-light text-pink-900 sm:mb-12 sm:text-4xl">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                className="rounded-xl bg-pink-50 p-6 shadow-lg"
              ...
              >
                <div className="mb-4 flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-base font-semibold text-pink-900 sm:text-lg">
                      {testimonial.name}
                    </h3>
