        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <div className="mb-4 flex items-center">
              <Tooth className="mr-2 h-6 w-6 text-blue-300 sm:h-8 sm:w-8" />
          ...
          <div>
            <h3 className="mb-4 text-base font-semibold text-blue-300 sm:text-lg">
              Enlaces Rápidos
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="#sobre-mi"
                  className="text-sm text-blue-200 hover:text-white sm:text-base"
                >
                  Sobre Mí
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-sm text-blue-200 sm:text-base">
                  +34 123 456 789
                </span>
              </li>
              <li className="flex items-center">
